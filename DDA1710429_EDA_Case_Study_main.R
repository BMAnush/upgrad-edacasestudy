...
ggplot(loan, aes(x = loan$purpose)) + geom_bar(stat = "count", aes(fill =
                                                                     loan$loan_status)) + geom_text(stat = 'count', aes(label = ..count..), vjust =
                                                                                                      -1)
...
ggplot(loan, aes(x = loan$emp_length)) + geom_bar(stat = "count", aes(fill =
                                                                        loan$loan_status)) + facet_wrap( ~ loan$term) + coord_flip()

ggplot(loan, aes(x = loan$emp_length)) + geom_bar(position = "fill", aes(fill =
                                                                           loan$loan_status)) + facet_wrap( ~ loan$term) + coord_flip()
